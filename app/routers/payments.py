...
from app.services.credit_service import (
    add_credits, get_balance,
    ALPHA_PACK_CREDITS, ALPHA_PACK_PRICE_CENTS,
)
            ...
            if session.payment_status == "paid":
                async with async_session() as db:
                    ...
                    if payment and payment.status != "completed":
                        ...
                        await add_credits(db, user.id, ALPHA_PACK_CREDITS)
        except Exception:
        ...
        if user_id and session.get("payment_status") == "paid":
            async with async_session() as db:
                ...
                if payment and payment.status != "completed":
                    ...
                    await add_credits(db, user_id, ALPHA_PACK_CREDITS)
